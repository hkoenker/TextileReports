...
Figure \@ref(fig:sigmultivar) summarizes countries where the most recent survey shows a correlation between the textile of a net and whether it was used the previous night. 
...
The textile is determined from the brand information collected in the survey; in some surveys the proportion of nets with an unknown brand can be considerable. Figure \@ref(fig:txtunknown) summarizes the proportion of nets with an unknown brand and thus an unknown textile.
